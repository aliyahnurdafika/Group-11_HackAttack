...
export default function Ingredients() {
  ...
  console.log(restrictions, allergies);
    ...
    <div className="flex flex-col items-center min-h-screen p-6 ingredients bg-custom">
      ...
      {recipeTitles.length > 0 && (
        <div className="w-64 mb-6">
          <h2 className="text-lg font-semibold text-[#415111] mb-2">
            Recipe Suggestions:
          </h2>
      ...
      {recipeDetails && (
        <div className="mt-4 p-4 bg-white rounded-lg shadow w-full max-w-xl text-[#415111]">
          ...
          {restrictions.length > 0 && (
            <p>
              <strong>Restrictions:</strong> {restrictions.join(", ")}
            </p>
          )}

          {allergies.length > 0 && (
            <p>
              <strong>Allergents:</strong> {allergies.join(", ")}
            </p>
          )}
